...
Friedman's fixed-money-growth-rule proposal is structurally the closest mainstream (non-Austrian) economic idea to Bitcoin's actual design: both replace central bank discretion with a fixed, pre-announced, mechanically enforced rule. The difference is a matter of degree and mechanism rather than philosophy — Friedman proposed a small but steady positive growth rate (accommodating ongoing real economic growth), enforced by a central bank following a legislated rule, while Bitcoin's issuance rate declines on a fixed schedule toward zero, enforced by protocol and network consensus rather than any institution's compliance with a law. Notably, Friedman himself expressed public interest in digital cash concepts before Bitcoin existed — in a 1999 interview, he speculated about the potential for a reliable form of anonymous electronic cash, though this predates and should not be read as an endorsement of Bitcoin's specific design, which did not yet exist. TODO: verify the exact wording and context of Friedman's 1999 remarks against a primary video or transcript source before quoting directly.

## Common misconceptions

**Monetarism is not the same school as Austrian economics**, despite both being skeptical of unconstrained discretionary monetary policy. Monetarism accepts fiat money and central banking as legitimate institutions requiring better rules, while Austrian economics (particularly in Rothbard's and Mises's more radical forms) argues central banking itself is the underlying problem. See [Murray Rothbard and Sound Money](./rothbard.md) for the contrast.
...
[← Previous: Keynesian Perspectives](./keynesian-perspectives.md)
·
[Back to Economics](./README.md)
·
[Next: Modern Monetary Theory →](./mmt.md)
