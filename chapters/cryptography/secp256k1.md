...
It is worth being precise about timing here: Bitcoin's whitepaper and initial code (2008–2009) predate the 2013 Dual_EC_DRBG revelations by several years, so provenance suspicion of NIST curves specifically was not a documented, contemporaneous justification available to Satoshi at the time of the original design choice, Satoshi's own reasoning for choosing secp256k1 specifically has not been documented in known public writings. TODO: verify whether any of Satoshi's mailing-list or forum posts directly address why secp256k1 was selected over the alternatives, before stating a specific motivation as documented.
